                                ...
                                <div className="uk-grid uk-grid-xsmall uk-grid-small@m uk-child-width-1-2@m uk-margin-medium-top uk-margin-large-top@m">
                                    <div>
                                        <div className="uk-panel uk-card uk-card-small uk-card-medium@m uk-card-border uk-radius-medium uk-radius-large@m uk-box-shadow-hover-small hover:uk-border-primary">
                                            ...
                                            <h4 className="uk-text-bold uk-h5@m uk-margin-small-top uk-margin-medium-top@m">Metamask(soon)</h4>
                                        </div>
                                    </div>
                                    <div className="gap-collect">
                                        <div className="uk-panel uk-card uk-card-small uk-card-medium@m uk-card-border uk-radius-medium uk-radius-large@m uk-box-shadow-hover-small hover:uk-border-primary">
                                            ...
                                            <h4 className="uk-text-bold uk-h5@m uk-margin-small-top uk-margin-medium-top@m">BitGo(soon)</h4>
                                        </div>
                                    </div>
                                    <div className="uk-grid-margin uk-first-column">
                                        <div className="uk-panel uk-card uk-card-small uk-card-medium@m uk-card-border uk-radius-medium uk-radius-large@m uk-box-shadow-hover-small hover:uk-border-primary">
                                            ...
                                            <h4 className="uk-text-bold uk-h5@m uk-margin-small-top uk-margin-medium-top@m">Trust Wallet(soon)</h4>
                                        </div>
                                    </div>
                                    <div className="uk-grid-margin uk-first-column">
                                        <div className="uk-panel uk-card uk-card-small uk-card-medium@m uk-card-border uk-radius-medium uk-radius-large@m uk-box-shadow-hover-small hover:uk-border-primary">
                                            ...
                                            <h4 className="uk-text-bold uk-h5@m uk-margin-small-top uk-margin-medium-top@m">Coinbase(soon)</h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
